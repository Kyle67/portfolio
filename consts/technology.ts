...
export const technology: Record<string, TechnologyData> = {
  Expo: {
    description:
  ...
  MongoDB: {
    description:
      "Through the use of MongoDB's many tools an effective database system can be setup. Good database architecture combined with well crafted indexes ensures fast and efficient queries. Aggregations provide the flexibility to create queries of any kind and ensure useful data can be generated. Other tools like Charts allow for rapid dashboards to be spun up and provided to clients for instant statistics",
